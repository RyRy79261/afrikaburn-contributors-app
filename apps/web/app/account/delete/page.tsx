...
export default async function AccountDeletePage() {
  ...
  if (!isDatabaseConfigured()) {
    return (
      <AppShell>
        <PreviewNotice feature="Account deletion" />
      </AppShell>
    );
  }
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2">
          ...
          <p className="text-xs text-muted-foreground sm:col-span-2">
            Your name in every camp becomes &ldquo;{DEPARTED_BURNER_NAME}&rdquo;.
            The threads you were part of stay whole — your identity doesn&rsquo;t.
          </p>
        </CardContent>
      </Card>
