...
export default async function EditArtworkPage({
  ...
  if (!isDatabaseConfigured()) {
    return <PreviewNotice feature="Editing an art project registration" />;
  }
    ...
    <>
      ...
      <div className="mx-auto max-w-3xl">
        <header className="mb-6 flex flex-col gap-3">
          ...
          <p className="text-sm text-muted-foreground">
            Update your project&apos;s registration and resubmit it. Save a
            draft any time — nothing goes back to the Art crew until you
            resubmit.
          </p>
          <div className="flex flex-wrap items-center gap-3">
            <StatusBadge status={ctx.status} />
