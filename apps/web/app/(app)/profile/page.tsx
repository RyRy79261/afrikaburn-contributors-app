...
export default async function ProfilePage({
  ...
  if (!isDatabaseConfigured()) {
    return <PreviewNotice feature="Your profile" />;
  }
  ...
  const onsite = contactSummary(
    fields.onsiteContactName,
    fields.onsiteContactPhone,
  );
      ...
      <div className="mx-auto flex max-w-2xl flex-col gap-6">
          ...
          <CardContent>
            <div className="flex flex-col divide-y divide-border">
              ...
              <BioRow
                ...
                visibility={vis(flags, "attendedYears")}
              >
              ...
              <BioRow label="Phone" value={fields.phone} visibility="locked" />
              <BioRow
          ...
          <CardContent className="flex flex-col gap-5">
            {!hasBurns && (
              <p className="text-sm text-muted-foreground">
                Nothing added yet — use Edit to tell other burners who you are
                in the dust.
              </p>
            )}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your signing key — a keypair generated for you at sign-up, held
              for future on-site QR attestations. You never manage it directly.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-xs uppercase tracking-wide text-muted-foreground">
