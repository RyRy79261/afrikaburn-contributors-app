...
export interface NotFoundViewProps {
   ...
   * the ROOT boundary, where nothing else is on screen. `"inline"` is for a
   * boundary INSIDE `app/(app)/layout.tsx`, whose header and nav are already
   * rendered; a second full-screen frame would stack two chromes.
   */
