...
//
// The app chrome around it comes from `app/(app)/layout.tsx` now, so this is
// only the account section's own header and nav — and `account/loading.tsx`
// mirrors exactly this shape, which is why switching account tabs no longer
// blanks the page.
