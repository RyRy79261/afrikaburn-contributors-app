...
// The console's wiring for the SHARED account components (@quagga/ui, roadmap
...
//
// Grouped in one file because each is three lines of glue and splitting them
// into four would make the wiring harder to read than the thing being wired.
