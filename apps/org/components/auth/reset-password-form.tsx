...
// Set a new password from an emailed link. ONE field (no confirm-twice),
// length-based strength, paste allowed. The reset invalidates every session on
// success (revokeSessionsOnPasswordReset in @quagga/auth) — the note under the
// button promises exactly that. A missing token is a different screen, not a
// disabled state.
