...
// Forgot-password request for the console. Enumeration-safe: the confirmation
// copy comes from the server action and is identical whether or not the account
// exists (the action discards the provider outcome). The confirmation renders in
// place of the form rather than redirecting, so nothing branches on success.
    ...
    <form onSubmit={submit} className="flex flex-col gap-4" noValidate>
      <div className="flex flex-col gap-1">
        ...
        <p className="text-sm text-muted-foreground">
          Enter your org email and we&rsquo;ll send a single-use reset link.
        </p>
      </div>
