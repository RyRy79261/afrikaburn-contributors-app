...
/**
 * /notifications — the console inbox: filter chips, then day-grouped rows inside
 * a card. A list, so rows rather than a card grid.
 */
export default function ConsoleNotificationsLoading() {
  return (
    <SkeletonRegion>
